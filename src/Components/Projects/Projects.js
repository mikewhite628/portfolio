        ...
        <div className='projects' style={{
           ...
           color: '#252a34'
            ...
            <h1 className='project-title'> Projects </h1>
                <div className='project1 project-shadow'><a href='https://mikewhite628.github.io/weather-app/'><img src={weatherPic} className='project-image weather-app'/></a></div>
                ...
                <div className='project2 project-shadow'><a href='https://mikewhite628.github.io/to-do-list//'><img src={todoPic} className='project-image todo-app'/></a></div>
                ...
                <div className='project3 project-shadow'><a href='https://mikewhite628.github.io/cv-project//'><img src={cvPic} className='project-image cv-app'/> </a></div>
